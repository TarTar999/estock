<?php
	class Employe{
		...
		public function __construct(){
		    ...
		    {
		        case 8:
		            $this->_constructWithAll($args[0],$args[1],$args[2],$args[3],$args[4],$args[5],$args[6],$args[7]);
		            break;
		        case 1:
		...
		public function _constructWithAll($id, $matricule, $nom, $prenom, $login, $pwd,Entite $entite,Role $role){
			$this->_idEmp=$id;
