	...
	class EntreeDAO{			
		public function commandeout($filtre)
		{
            ...
            while($data=$req->fetch(PDO::FETCH_ASSOC)){
				...
				$employes=$entrepotdao->entrepotOut("id_entrepot=".$data['entrepot']);
				$employe=$employes[1]['object'][0]['objet'];
				$entree= new Entree($data['id_entree'], $data['nbre_mat_entree'], $data['qte_mat_entree'], $data['date_entree'], $employe, $entrepot);				
